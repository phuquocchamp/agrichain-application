        ...
        try {
          ...
          if (product) {
            ...
            const productObj = {
              ...
              slicesRemaining: p.slicesRemaining !== undefined ? p.slicesRemaining : p[8],
              slicesSold: p.slicesSold !== undefined ? p.slicesSold : p[9],
              parentProduct: p.parentProduct !== undefined ? p.parentProduct : p[10],
              itemState: p.itemState !== undefined ? p.itemState : p[11],
              distributorID: p.distributorID !== undefined ? p.distributorID : p[12],
              retailerID: p.retailerID !== undefined ? p.retailerID : p[13],
              consumerID: p.consumerID !== undefined ? p.consumerID : p[14],
              shippingDeadline: p.shippingDeadline !== undefined ? p.shippingDeadline : p[15],
              receivingDeadline: p.receivingDeadline !== undefined ? p.receivingDeadline : p[16],
              isExpired: p.isExpired !== undefined ? p.isExpired : p[17],
              ipfsHash: p.ipfsHash !== undefined ? p.ipfsHash : p[18],
            };
